...
public interface HandInterface extends Comparable {
   ...
   * @return the card removed from the hand, or null if the card was not present
   *         in the hand.
   */
   ...
   * @return the card removed from the hand, or the null reference if the index is
   *         out of bounds.
   */
   ...
   * the hand.
   * 
   * @return returns Card [] of Cards found in hand or <code>-null </code> if not
   *         found.
   */
  public Card[] findSet();
