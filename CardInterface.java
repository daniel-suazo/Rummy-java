...
public interface CardInterface extends Comparable<Card> {
   ...
   /**
    * Creates a new playing card initialize the three instance data members of this
    * class
    * 
   ...
   /**
    * Returns a String iby the name of the directory named above concatonated with
    * the toString method of Card and ".gif"
    */
    ...
    * one of the following chars - c,d,h,s
    * 
    ...
    * their rank index as defined in the char static array named rank.
    * 
