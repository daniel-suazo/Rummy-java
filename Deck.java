...
public class Deck {
    ...
    /**
     * removes first card on a deck so equivalent to flipping the card off of a deck
     * that is faced down
     * 
    ...
    /**
     * removes Card last card placed on a deck so equivalent to removing card from
